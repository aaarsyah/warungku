...
<html>
    ...
    <body>
        <header>
            <div class="container">
            <a href="dashboard.php"><img src="img/icon-warungku.png" width="60px"></a>  
            ...
            <div class="container">
                ...
                <div class="box">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <p><a>Status Produk</a></p>
                        <select class="input-control" name="status">
                            <option value="">--Pilih--</option>
                            <option value="1" <?php echo ($p->product_status == 1)? 'selected':''; ?>>Tersedia</option>
                            <option value="2" <?php echo ($p->product_status == 2)? 'selected':''; ?>>Tidak Tersedia</option>
                        </select>
